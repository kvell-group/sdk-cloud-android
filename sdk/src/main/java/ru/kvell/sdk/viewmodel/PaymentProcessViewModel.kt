...
internal class PaymentProcessViewModel(
	...
	@Inject
	lateinit var api: KvellPaymentsApi
	...
	fun pay() {
		...
		val jsonDataString: String = try {
			...
			Log.e("KvellPaymentsSDK", "JsonSyntaxException in JsonData")
			""
		}
	...
	private fun checkTransactionResponse(transactionResponse: KvellPaymentsTransactionResponse){
...
internal data class PaymentProcessViewState(
	...
	val transaction: KvellPaymentsTransaction? = null,
