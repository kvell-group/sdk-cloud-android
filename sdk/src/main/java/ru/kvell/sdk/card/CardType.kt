...
enum class CardType {
	...
	fun getIconRes(): Int? = when (this) {
		VISA -> R.drawable.kvell_ic_ps_visa
		MASTER_CARD -> R.drawable.kvell_ic_ps_mastercard
		MAESTRO -> R.drawable.kvell_ic_ps_maestro
		MIR -> R.drawable.kvell_ic_ps_mir
		JCB -> R.drawable.kvell_ic_ps_jcb
		else -> null
	}
}