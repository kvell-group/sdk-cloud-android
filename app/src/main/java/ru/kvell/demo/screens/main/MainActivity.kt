package ru.kvell.demo.screens.main
...
import ru.kvell.sdk.api.models.PaymentDataPayer
...
class MainActivity : BaseActivity() {
	...
	private val kvellSdkLauncher = KvellPaymentsSDK.getInstance().launcher(this, result = {
		if (it.status != null) {
