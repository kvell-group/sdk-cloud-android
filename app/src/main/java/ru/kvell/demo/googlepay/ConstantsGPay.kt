package ru.kvell.demo.googlepay
...
object ConstantsGPay {
	...
	val SUPPORTED_METHODS =
		Arrays.asList( // PAYMENT_METHOD_CARD returns to any card the user has stored in their Google Account.
			WalletConstants.PAYMENT_METHOD_CARD,  // PAYMENT_METHOD_TOKENIZED_CARD refers to cards added to Android Pay, assuming Android
			// Pay is installed.
	...
	// more information.
	const val GATEWAY_TOKENIZATION_NAME = "cloudpayments"
	...
	val GATEWAY_TOKENIZATION_PARAMETERS = Arrays.asList(
		Pair.create<String, String>("gatewayMerchantId", Constants.MERCHANT_PUBLIC_ID)
	)
}